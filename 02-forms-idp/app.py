# app.py — Streamlit dashboard for Forms & Intelligent Document Processing (demo mode).
import os, sys
...
st.set_page_config(page_title="Forms & Intelligent Document Processing", page_icon="🏛️", layout="wide")
st.title("🏛️ Forms & Intelligent Document Processing")
CLAIMS={"sub":"staff-1","custom:slg_role":"INTAKE_SPECIALIST"}
q=st.text_input("Request","upload")
if st.button("Run"):
