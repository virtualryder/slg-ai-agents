...
INTENTS = {'search': ['find', 'search', 'records about', 'responsive'], 'classify': ['classify', 'responsive', 'duplicate'], 'redact': ['redact', 'exemption', 'protect'], 'package': ['package', 'produce', 'assemble', 'release package'], 'status': ['status', 'my request', 'clock', 'deadline']}
PERSONAL_INTENTS = set([])
DEFAULT_INTENT = 'search'
GATHER_TOOL = 'records.search'
GATHER_ARGS = {}
WRITE_TOOL = 'records.assemble_package'
WRITE_ARGS = {'record_count': 12}
WRITE_ACTION = 'ASSEMBLE_PACKAGE'
DONE_STATUS = 'PACKAGE_READY'
...
def produce(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    artifact = {"summary": "FOIA production package prepared from approved source data.",
