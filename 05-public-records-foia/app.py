# app.py — Streamlit dashboard for Public Records / FOIA & Redaction (demo mode).
import os, sys
...
st.set_page_config(page_title="Public Records / FOIA & Redaction", page_icon="🏛️", layout="wide")
st.title("🏛️ Public Records / FOIA & Redaction")
CLAIMS={"sub":"staff-1","custom:slg_role":"RECORDS_TECH"}
q=st.text_input("Request","find")
if st.button("Run"):
