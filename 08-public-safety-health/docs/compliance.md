...
**Domain guard.** AI must not independently establish probable cause, calculate dangerousness, recommend sentencing, make a medical diagnosis, or initiate enforcement. CJI, PHI and public data stay in separate environments; surveillance SQL is validated deterministically before execution.

**Key obligations:** FBI CJIS v6.0, HIPAA/PHI, public-records.
