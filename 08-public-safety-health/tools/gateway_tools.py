# tools/gateway_tools.py — Public Safety / Public Health Case & Report
...
AGENT_ID = "08-public-safety-health"
try:
    from slg_agent_platform.mcp_gateway import MCPGateway
    _GATEWAY: Optional[Any] = MCPGateway()
except Exception:  # pragma: no cover
    _GATEWAY = None
def call(claims: Dict[str, Any], tool: str, args: Dict[str, Any], approval: Optional[Dict[str, Any]] = None) -> Any:
    if _GATEWAY is None:
