"""Demo (no API key) for Public Safety / Public Health Case & Report."""
import json, os, sys
...
def main():
    for req in json.loads((_REPO/"08-public-safety-health/data/fixtures/sample_requests.json").read_text()):
