# app.py — Streamlit dashboard for Public Safety / Public Health Case & Report (demo mode).
import os, sys
...
st.set_page_config(page_title="Public Safety / Public Health Case & Report", page_icon="🏛️", layout="wide")
st.title("🏛️ Public Safety / Public Health Case & Report")
CLAIMS={"sub":"staff-1","custom:slg_role":"PUBLIC_SAFETY_ANALYST"}
q=st.text_input("Request","summarize")
if st.button("Run"):
