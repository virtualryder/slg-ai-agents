# agent/graph.py — Public Safety / Public Health Case & Report
...
def build_graph(use_memory: bool = True):
    ...
    for n, fn in [("intake",intake),("classify_intent",classify_intent),("check_identity",check_identity),
                  ("gather",gather),("produce",produce),("compliance_check",compliance_check),
