"""Demo (no API key) for GovOps IT Service Desk & Modernization."""
import json, os, sys
...
def main():
    for req in json.loads((_REPO/"07-govops-service-desk/data/fixtures/sample_requests.json").read_text()):
