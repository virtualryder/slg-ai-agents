...
---
## Results-slide gains (added) — documented outcomes, vendor/peer-reviewed labeled
*Flagship credibility anchor: CDC TowerScout is **gov + peer-reviewed**. Public-safety slide carries the peer-reviewed **null-result RCT** on-slide for honesty.*

- **Resident Services / 311:** Indiana 311 — ~4,000 calls/month deflected (Tars, **vendor-reported**, named gov) https://hellotars.com/ai-agents/311-citizen-service-ai-agent · Grupo TX −35% volume / 50% faster (AWS, above) · Gartner ~$8 vs $0.10 (above).
- **Forms / IDP:** error risk −52%+ / error rate <1% / 95%+ STP (RaftLabs, **vendor-reported**) https://www.raftlabs.com/intelligent-document-processing/intelligent-document-processing-for-government-and-public-services/ · Anne Arundel 45 min→<20s & Arizona 49% (AWS, above).
- **Permitting:** Honolulu CivCheck pilot — residential plan-review time **−70%**, corrections ~23.2→8.8, per-plan ~60–90→15–20 min, cycles 2.3→1.4 (**vendor-reported, City & County of Honolulu DPP**) https://www.civcheck.ai/blog/honolulu-pilot-case-study-2024 · caveat: −70% is reviewer time; end-to-end issuance still varies (Honolulu Civil Beat, Apr 2025) https://www.civilbeat.org/2025/04/speedier-reviews-quicker-honolulu-building-permits-not-so-fast/
- **Benefits / HHS:** Nevada DETR + Google — unemployment appeal decision ~3 hrs→~5 min (**4× faster**), appeals backlog 40,000+→<5,000, prescreen ~30× faster (**named state deployment**) https://statescoop.com/nevada-ai-unemployment-prescreen-claims/ · https://www.route-fifty.com/artificial-intelligence/2025/05/nevada-turns-ai-speed-unemployment-appeals/404987/ · NC DES 2,700 mo.1 (AWS, above).
- **Public Records / FOIA:** CaseGuard — document redaction **−98%**, investigative files **32× faster** (Homeland Security Investigations Forensics Lab named; **vendor-reported**) https://caseguard.com/articles/how-federal-agencies-use-ai-to-clear-foia-redaction-backlogs/ · Kofile hours→seconds (AWS, above) · DOJ backlog 267,056 (above).
- **Procurement:** −50% internal review cycle / 50–70% drafting time / −17% RFP completion (Inventive.ai, **vendor-reported**) https://www.inventive.ai/blog-posts/ai-government-rfp-workflow-tips · 57-day avg cycle (Euna, above).
- **GovOps service desk:** IBM AskIT — **75%** of IT queries self-resolved (watsonx, **vendor-reported**) https://www.ibm.com/case-studies/cio-watsonx-askit · ServiceNow Now Assist — MTTR **−50–70%** tier-1/2 (**vendor-reported**) · NBER +14%/+34% (peer-reviewed, above) · Gartner ~80× (above).
- **Public Safety / Health:** CDC TowerScout — cooling-tower ID **−98%** (4 hr→5 min), ~600× faster (**gov + peer-reviewed**) https://www.cdc.gov/public-health-data-strategy/php/story/using-ai-to-improve-public-health-efficiency.html · https://www.thelancet.com/journals/landig/article/PIIS2589-7500(24)00094-3/fulltext · Axon Draft One — Leon County **−61%** (24.6→9.46 min), 2.2M min across 100k+ reports (**vendor-reported**) https://www.axon.com/blog/reducing-time-spent-on-report-writing-for-officers · **Counter-evidence (on-slide):** pre-registered **RCT found no significant time saving** https://link.springer.com/article/10.1007/s11292-024-09644-7 ; Anchorage PD non-renewal (EFF) https://www.eff.org/deeplinks/2025/03/anchorage-police-department-ai-generated-police-reports-dont-save-time

> Labeling discipline for slides: **vendor-reported** figures are tagged as such; the only **gov + peer-reviewed** stat is CDC TowerScout (lead with it for credibility). Arizona 49% and the Honolulu day-count figures should be reconfirmed against the original government source before print.
