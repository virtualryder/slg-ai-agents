...
- **Results — Oklahoma OMES (Celonis Process Copilot)** *(NAMED STATE — strongest)* — AI/process-intelligence on the state's PeopleSoft data **flagged $6.8B in purchasing inefficiencies**; after a legislative report found **$3B** of purchases lacked oversight, OMES **reviewed all procurement for 100+ agencies in 60 days** (vs. up to **8 audits/year** before, often on 2–3-year-old purchases); caught agencies paying **45% below** the statewide contract, forcing a renegotiation. Named official Janet Morrow (Dir., OMES Risk, Assessment & Compliance); Gov. Stitt directed. **[ANALYST/TRADE-PRESS · named-gov-attributed]** GovTech, Feb 6, 2025. https://www.govtech.com/artificial-intelligence/oklahoma-using-ai-to-simplify-procurement-save-money
  - *Honesty: this is procurement **oversight / spend-analytics** AI, not solicitation drafting — present as proof AI returns hard dollars in state procurement, then tie back to the drafting agent.*
- **Results — Commonwealth of Pennsylvania (ChatGPT Enterprise pilot)** *(NAMED STATE)* — **~8 hours/week** saved per worker (~95 min/day); 175 employees / 14 agencies; procurement/contract analysis a **named** beneficiary. Gov. Shapiro on the record. **[GOV-attributed · trade press]** StateScoop, Mar 21, 2025. https://statescoop.com/chatgpt-pennsylvania-governor-sharpiro-pilot-program/
- **Results — City of Dallas + Hazel AI** *(NAMED CITY · drafting, outcomes emerging)* — first major Texas city using AI for procurement (drafting solicitations, vendor ID, compliance); no AI-attributable hard metric yet. **[TRADE PRESS]** Smart Cities Dive, Aug 13, 2025. https://www.smartcitiesdive.com/news/dallas-procurement-ai-cities/757555/
  - *Grants: no named state/local **grants**-AI deployment with a hard, AI-attributable metric found in public reporting (June 2026). Do NOT cite Treasury RESTORE "233→75 days" as AI — that turnaround came from hiring/process redesign, not AI. Keep grants framed as drafting/intake assistance, outcomes emerging.*
  - *Dropped: Inventive.ai "~70%" — on inspection it's a hypothetical blog illustration with no named customer, not a deployment.*
