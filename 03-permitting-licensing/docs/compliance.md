...
**Domain guard.** The agent may recommend an application is complete, but permit issuance and code interpretation remain with an authorized official; it must distinguish a deterministic code rule from a discretionary judgment.  **Key obligations:** local code, ADA Title II, records retention.
