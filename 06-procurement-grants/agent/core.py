...
INTENTS = {'find': ['find a contract', 'vehicle', 'cooperative', 'funding', 'grant opportunity'], 'draft_rfp': ['draft', 'rfp', 'solicitation', 'requirements', 'scope'], 'compare': ['compare', 'evaluate', 'score', 'bids', 'proposals'], 'status': ['status', 'where is', 'deadline']}
PERSONAL_INTENTS = set([])
DEFAULT_INTENT = 'draft_rfp'
GATHER_TOOL = 'procurement.search_contracts'
GATHER_ARGS = {}
WRITE_TOOL = 'procurement.draft_rfp'
WRITE_ARGS = {}
WRITE_ACTION = 'DRAFT_RFP'
DONE_STATUS = 'RFP_DRAFTED'
...
def produce(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    artifact = {"summary": "draft solicitation package prepared from approved source data.",
