...
## What it does
Classifies intent (find · draft_rfp · compare · status), gathers from approved systems via the governed gateway, produces a **draft solicitation package**, runs a compliance check (grounding · accessibility · PII · domain guard), pauses at the **human review gate**, and finalizes only after approval.
