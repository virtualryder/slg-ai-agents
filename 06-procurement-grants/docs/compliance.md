...
**Domain guard.** The agent organizes evidence and applies a deterministic, published scoring rubric; it must NOT select a winning bidder or alter evaluation criteria — the procurement officer owns the legally consequential award.  **Key obligations:** procurement law, required clauses, grant terms, immutable evaluation record.
