...
**Systems:** ERP/e-procurement, grants systems, IDP, KB. Identity is established at the edge (Cognito federating the agency IdP); verified claims (`sub`, `custom:slg_role`) are forwarded and authorized by the gateway. A user can never retrieve, through the agent, anything they could not retrieve themselves.
