# app.py — Streamlit dashboard for Benefits / HHS Caseworker Assist (demo mode).
import os, sys
...
st.set_page_config(page_title="Benefits / HHS Caseworker Assist", page_icon="🏛️", layout="wide")
st.title("🏛️ Benefits / HHS Caseworker Assist")
CLAIMS={"sub":"staff-1","custom:slg_role":"ELIGIBILITY_CASEWORKER"}
q=st.text_input("Request","qualify")
if st.button("Run"):
