...
**Domain guard.** Eligibility determination runs in a deterministic rules engine OUTSIDE the LLM. The agent prescreens (nonbinding), organizes evidence and drafts notices; it never adjudicates, denies, or terminates a benefit.  **Key obligations:** HIPAA / MARS-E→ARC-AMPE, IRS Pub 1075, SSA data-exchange, program rules.
