...
INTENTS = {'prescreen': ['qualify', 'eligible', 'prescreen', 'what benefits'], 'status': ['status', 'my case', 'my application'], 'apply': ['apply', 'application', 'renew', 'renewal'], 'notice': ['notice', 'letter', 'request for information', 'rfi']}
PERSONAL_INTENTS = set(['status'])
DEFAULT_INTENT = 'prescreen'
GATHER_TOOL = 'eligibility.screen'
GATHER_ARGS = {}
WRITE_TOOL = 'eligibility.create_application'
WRITE_ARGS = {'program': 'SNAP'}
...
def produce(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    artifact = {"summary": "eligibility evidence package prepared from approved source data.",
