#!/usr/bin/env python3
"""Reviewer STAND-IN for the 02-forms-idp smoke test (P7 replaces with a real reviewer service).
...
ACTION_TOOL = {'ASSEMBLE': 'idp.assemble_form'}
...
approver = os.getenv("REVIEWER_SUB", "forms-supervisor-1")
if tool:
