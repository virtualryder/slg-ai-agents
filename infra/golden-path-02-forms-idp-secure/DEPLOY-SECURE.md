# 02-forms-idp — Secure Combined Deploy (P8)

Production-shaped counterpart to `infra/golden-path-02-forms-idp/`. **One `sam deploy`** stands up the
...
## Deploy
```bash
cd infra/golden-path-02-forms-idp-secure
AWS_REGION=us-east-1 ./deploy.sh slg-02-secure-dev
```
