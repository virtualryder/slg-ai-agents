#!/usr/bin/env python3
"""Reviewer STAND-IN for the 06-procurement-grants smoke test (P7 replaces with a real reviewer service).
Computes the pending tool from the sample input and mints a BOUND, SoD approval token."""
import json, os, sys
_HERE = os.path.dirname(os.path.abspath(__file__))
AGENT = "06-procurement-grants"
...
approver = os.getenv("REVIEWER_SUB", "contracting-officer-1")
if tool:
