# 05-public-records-foia — Secure Combined Deploy (P8)

Production-shaped counterpart to `infra/golden-path-05-public-records-foia/`. **One `sam deploy`** stands up the
...
## Deploy
```bash
cd infra/golden-path-05-public-records-foia-secure
AWS_REGION=us-east-1 ./deploy.sh slg-05-secure-dev
```
