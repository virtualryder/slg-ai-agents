#!/usr/bin/env python3
"""Reviewer STAND-IN for the 04-benefits-caseworker smoke test (P7 replaces with a real reviewer service).
Computes the pending tool from the sample input and mints a BOUND, SoD approval token."""
import json, os, sys
_HERE = os.path.dirname(os.path.abspath(__file__))
AGENT = "04-benefits-caseworker"
...
approver = os.getenv("REVIEWER_SUB", "eligibility-supervisor-1")
if tool:
