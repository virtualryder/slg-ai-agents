# 06-procurement-grants — Secure Combined Deploy (P8)

Production-shaped counterpart to `infra/golden-path-06-procurement-grants/`. **One `sam deploy`** stands up the
...
## Deploy
```bash
cd infra/golden-path-06-procurement-grants-secure
AWS_REGION=us-east-1 ./deploy.sh slg-06-secure-dev
```
