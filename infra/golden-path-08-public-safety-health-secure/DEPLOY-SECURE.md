# 08-public-safety-health — Secure Combined Deploy (P8)

Production-shaped counterpart to `infra/golden-path-08-public-safety-health/`. **One `sam deploy`** stands up the
...
## Deploy
```bash
cd infra/golden-path-08-public-safety-health-secure
AWS_REGION=us-east-1 ./deploy.sh slg-08-secure-dev
```
