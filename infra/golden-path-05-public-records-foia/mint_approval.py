#!/usr/bin/env python3
"""Reviewer STAND-IN for the 05-public-records-foia smoke test (P7 replaces with a real reviewer service).
Computes the pending tool from the sample input and mints a BOUND, SoD approval token."""
import json, os, sys
_HERE = os.path.dirname(os.path.abspath(__file__))
AGENT = "05-public-records-foia"
...
ACTION_TOOL = {'ASSEMBLE_PACKAGE': 'records.assemble_package'}
...
approver = os.getenv("REVIEWER_SUB", "records-officer-1")
if tool:
