# 04-benefits-caseworker — Secure Combined Deploy (P8)

Production-shaped counterpart to `infra/golden-path-04-benefits-caseworker/`. **One `sam deploy`** stands up the
...
## Deploy
```bash
cd infra/golden-path-04-benefits-caseworker-secure
AWS_REGION=us-east-1 ./deploy.sh slg-04-secure-dev
```
